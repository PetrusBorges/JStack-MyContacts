//styled-components
import { Container, InputSearchContainer, Header, ErrorContainer, EmptyListContainer, ListHeader, SearchNotFoundContainer, Card } from "./styles"
    ...
    <Container>
      ...
      {!hasError && (
        <>
          ...
          {(contacts.length >= 1 && filteredContacts.length < 1) && (
